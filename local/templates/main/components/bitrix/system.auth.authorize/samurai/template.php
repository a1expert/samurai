...
?>
		...
		<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
			...
			<table class="bx-auth-table">
				<tr>
					...
					<td><input class="bx-auth-input input authInput form-control" type="text" name="USER_LOGIN" maxlength="255" value="<?=$arResult["LAST_LOGIN"]?>" /></td>
				</tr>
				<tr>
					<td class="bx-auth-label"><?=GetMessage("AUTH_PASSWORD")?></td>
					<td><input class="bx-auth-input input authInput form-control" type="password" name="USER_PASSWORD" maxlength="255" autocomplete="off" />
	...
	<?endif?>
				...
				<?if($arResult["CAPTCHA_CODE"]):?>
					...
					<tr>
						...
						<td><input class="bx-auth-input input authInput form-control" type="text" name="captcha_word" maxlength="50" value="" size="15" /></td>
					</tr>
				<?endif;?>
	...
	<?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?>
			<noindex>
				<p>
					<a href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow" class="info__city-name"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a>
				</p>
			</noindex>
	<?endif?>
	...
	<?if($arParams["NOT_SHOW_LINKS"] != "Y" && $arResult["NEW_USER_REGISTRATION"] == "Y" && $arParams["AUTHORIZE_REGISTRATION"] != "Y"):?>
			<noindex>
				<p>
					<a href="<?=$arResult["AUTH_REGISTER_URL"]?>" rel="nofollow" class="info__city-name"><?=GetMessage("AUTH_REGISTER")?></a><br />
